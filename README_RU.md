...
На основе подготовленных данных, ML-прогнозов и дашборда Power BI можно выделить несколько закономерностей:

* Самые высокие медианные цены за квадратный метр наблюдаются в центральных районах, включая Арбат, Хамовники, Тверской, Пресненский и Якиманку.
* Новостройки в среднем дороже объектов вторичного рынка, особенно в более близких к центру зонах.
* На арендную ставку заметно влияют площадь квартиры, количество комнат, качество ремонта и наличие меблировки.
* Самая высокая прогнозная арендная доходность не сосредоточена в самых дорогих центральных районах. Более удалённые районы могут выглядеть привлекательнее по доходности, потому что прогнозная цена покупки там ниже относительно ожидаемой аренды.
* Прогнозная арендная доходность обычно снижается ближе к центру, потому что цены покупки растут быстрее, чем арендные ставки.
* Инвестиционный анализ стоит воспринимать как сравнительный инструмент для первичного отбора районов, а не как прямую инвестиционную рекомендацию. Расчёт валовой доходности не учитывает налоги, простой квартиры, обслуживание, ипотеку и расходы на сделку.
